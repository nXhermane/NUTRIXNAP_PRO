...
export class DomainEvents {
   ...
   private static findMarkedAggregateByID(id: AggregateID): AggregateRoot<any> {
      let found: AggregateRoot<any> = null as unknown as AggregateRoot<any>;
   ...
   public static dispatchEventsForAggregate(id: AggregateID): void {
