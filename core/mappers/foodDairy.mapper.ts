...
export default class FoodDiaryMapper implements IFoodDiaryMapper {
   ...
   mapDtoToCreateEntity(dto: FoodDiaryDTO): CreateFoodDiaryType {
      const createEntity: CreateFoodDiaryType = {
         ...
         foodQuantities: this.convertFoodQuantitiesToJsonStr(dto.foodQuantities),
         date: dto.date,
         meals: dto.meals,
   ...
   mapUpdateDtoToUpdateEntity(dto: UpdateFoodDiaryDto): UpdateFoodDiaryType {
      ...
      const updateEntity: UpdateFoodDiaryType = {
         ...
         ...(foodQuantities && {
            foodQuantities: this.convertFoodQuantitiesToJsonStr(foodQuantities),
         }),
      };
   ...
   mapEntityToDto(entity: FoodDiaryEntity): FoodDiaryDTO {
      const dto = {
         ...
         foodQuantities: this.convertJsonStrToFoodQuantities(entity.foodQuantities),
         date: entity.date,
         meals: entity.meals,
   ...
   private convertFoodQuantitiesToJsonStr(foodQuantities: FoodQuantity): string {
   ...
   private convertJsonStrToFoodQuantities(foodQuantities: string): FoodQuantity {
