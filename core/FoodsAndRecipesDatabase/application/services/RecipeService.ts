...
export class RecipeService implements IRecipeService {
    constructor(
        ...
        private getNutritionnalValueUC: UseCase<
            GetRecipeNutritionnalValueRequest,
            GetRecipeNutritionnalValueResponse
        >
    ) {}
    async createRecipe(
        ...
        try {
            ...
            if (e instanceof CreateRecipeError)
    ...
    async deleteRecipe(
        ...
        try {
            ...
            if (e instanceof DeleteRecipeError)
                return new Message("error", e.message);
            return new Message("error", "Unspected Error.Retry this action.");
        }
    }
    async getRecipeById(
        ...
        try {
            ...
            if (e instanceof GetRecipeByIdError)
                return new Message("error", e.message);
            return new Message("error", "Unspected Error.Retry this action.");
        }
    }
    ...
    async getAllRecipe(
        ...
        try {
            ...
            if (e instanceof GetAllRecipeError)
                return new Message("error", e.message);
            return new Message("error", "Unspected Error.Retry this action.");
        }
    }
    async getRecipeNutritionnalValue(
        ...
        try {
            ...
            if (e instanceof GetRecipeNutritionnalValueError)
                return new Message("error", e.message);
            return new Message("error", "Unspected Error.Retry this action.");
        }
    }
