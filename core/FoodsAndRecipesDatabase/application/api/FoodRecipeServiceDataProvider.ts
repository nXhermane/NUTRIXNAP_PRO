import { RecipeRepository, FoodRepository, FoodRepositoryNotFoundException, RecipeRepositoryNotFoundException, RecipeRepositoryError, FoodRepositoryError } from "./../../infrastructure";
...
export class FoodRecipeServiceDataProvider implements IFoodRecipeServiceDataProvider {
  constructor(private foodRepo: FoodRepository, private recipeRepo: RecipeRepository) { }
