...
export class GetAllRecipeUseCase
    implements UseCase<GetAllRecipeRequest, GetAllRecipeResponse>
{
    constructor(
    ...
    async execute(
        request: GetAllRecipeRequest = {}
    ): Promise<GetAllRecipeResponse> {
        try {
            ...
            return recipes.map((recipe: Recipe) =>
                this.mapper.toResponse(recipe)
            ) as GetAllRecipeResponse;
        } catch (e) {
