...
export class PersonalAndSocialStory extends Entity<IPersonalAndSocialStory> {
   constructor(createProps: CreateEntityProps<IPersonalAndSocialStory>) {
      if (Guard.isEmpty(createProps.props.isSmoker)) createProps.props.isSmoker = false;
      if (Guard.isEmpty(createProps.props.isAlcoholConsumer)) createProps.props.isAlcoholConsumer = false;
      super(createProps);
   }
