...
export class BodyCompositionMeasurement extends ValueObject<IBodyCompositionMeasurement> {
   ...
   validate(props: IBodyCompositionMeasurement): void {
      ...
      if (props.value < 0) throw new NegativeValueError('La valeur du mesure de composition corporelle ne peut etre inferieur à zéro.');
      if (Guard.isEmpty(props.unit)) throw new EmptyStringError("L'unité du mesure du mesure de composition corporelle doit etre fournir.");
   }
}
