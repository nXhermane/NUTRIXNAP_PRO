...
const patient = (props: Props) => {
   ...
   const [displayAddPatientForm, setDisplayAddPatientForm] = useState<boolean>(false);
   const [displayEditPtientForm, setDisplayEditPtientForm] = useState<boolean>(false);
            ...
            <View style={style.container}>
               ...
               {displayAddPatientForm && (
                  <PatientForm
                     ...
                     popupIsOpen={(val: boolean) => setDisplayAddPatientForm(val)}
               ...
               {displayEditPtientForm && (
                  <PatientForm
                     animatedData={patientAnimatedData}
                     popupIsOpen={(val: boolean) => setDisplayEditPtientForm(val)}
                     isUpdate={true}
