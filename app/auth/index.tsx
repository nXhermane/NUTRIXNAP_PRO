...
const index = (props: Props) => {
   ...
   const [request, response, promptAsync] = Google.useAuthRequest(API.googleAuth);
         ...
         <View style={style.getStartedContainer}>
            ...
            <View style={style.getStartedBody}>
               ...
               <Text style={style.getStartedBodyParagraph}>
                  Prêt à commencer ? Connectez-vous pour profiter de NutriXnap: l'application qui vous simplifie la vie de diététicien.
               </Text>
            </View>
                     ...
                     router.navigate({
                        ...
                        params: {
                           user: JSON.stringify({
                              ...
                              given_name: 'Hermano',
                              family_name: 'Dossou',
                              picture: 'https://lh3.googleusercontent.com/a/ACg8ocL10GHjCILxoFxiWqckBVP5kUiUJ9jq7I0W20vUMk6r=s96-c',
                              locale: 'fr',
                           }),
                        },
                     });
