      ...
      <View style={style.container}>
         <View style={style.getUserInfoContainer}>
            <View style={style.topTextContainer}>
               <Text style={style.topText}>{'Continuer en tant que ' + userInfo.given_name + ' ?'}</Text>
            </View>
            <View>
               <TouchableOpacity style={style.avatarsContainer} underlayColor={theme.colors.bg.primary} onPress={() => alert('change Profile image')}>
                  <Avatars
            ...
            <View style={style.loginInfoActionBtnContainer}>
               ...
               />
               {displayLoginModal && (
                  <LoginModal popupIsOpen={(val: boolean) => setDisplayLoginModal(val)} animatedData={modalAninatedData} userInfo={userInfo} />
               )}
               <Button
