...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(drawer)/(home)/agenda` | `/agenda` | `/(drawer)/(home)/food` | `/food` | `/(drawer)/(home)/` | `/(drawer)/(home)` | `/(drawer)/(home)/patient` | `/patient` | `/(drawer)/` | `/(drawer)` | `/(drawer)/notification` | `/notification` | `/auth/` | `/auth/logininfo` | `/forms/addFoodForm` | `/search/search` | `/search/searchFoods` | `/search/searchPatient`;
  // prettier-ignore
