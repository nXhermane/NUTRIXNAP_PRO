...
import { AppAlertContext, IAppAlertContext, AlertConfirmOption } from './Context';
...
export const AppAlertProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
   ...
   const [alertConfirmOption, setAlertConfirmOption] = useState<AlertConfirmOption>({});
   const [alertConfirmResult, setAlertConfirmResult] = useState<boolean>(false);
