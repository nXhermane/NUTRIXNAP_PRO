...
const useCalendarData = (calendar) => {
   ...
   const getData = {
      ...
      DataForCalendar: (minYear, maxYear) => calendar.generateDataForCalendarFromMaxAndMinYear(minYear, maxYear),
      WDN: () => calendar.getDayNames(),
      MN: (localizedCode, monthNameType) => calendar.getMonthNames(localizedCode, monthNameType),
