...
const maxYear = 2030;
const minYear = 2020;
const CALENDARDATA = calendarClass.generateDataForCalendarFromMaxAndMinYear(
    minYear,
    maxYear
);
...
const Calendar = ({
    ...
    const nextMonth = () => {
        ...
        setCurrentDateString(
            CALENDARDATA[CALENDARDATAKEYS[offsetNumber]].dateString
        );
    ...
    useEffect(() => {
        virtualListContainerHeight.value = withTiming(
            hideBody ? 0 : size.height * 0.33,
            { duration: 1000 }
        );
    }, [hideBody]);
            ...
            >
                <VirtualizedList
                    ...
                    onScroll={Animated.event(
                        ...
                        { listener: scrollHandler, useNativeDriver: false }
                    )}
