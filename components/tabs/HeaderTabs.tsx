...
const HeaderTabs = ({ nav }: Props) => {
   ...
   return (
      <BlurView experimentalBlurMethod={'dimezisBlurView'} intensity={15} tint={theme.isLightTheme ? 'light' : 'dark'} style={style.headerContainer}>
         ...
         <View style={style.headerLeft}>
            ...
            <Pressable style={style.icon} onPress={() => router.navigate('(drawer)/notification')}>
               {({ pressed }) => <Ionicons name="notifications-sharp" size={theme.size.s5} color={pressed ? theme.colors.blue : theme.colors.b} />}
            </Pressable>
         </View>
      </BlurView>
   );
