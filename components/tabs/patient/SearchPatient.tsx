...
const SearchPatient = (props: Props) => {
    ...
    return (
        <DashBoardSection
            body={
                "Recherchez des Patients par nom,numéro de contact ou d'identification,email,occupation..."
            }
        >
            <SearchBtn placeholder={"Recherchez des patients"}
            searchPageLink={"search/searchPatient"} />
