...
const FoodsList = (props: Props) => {
   ...
   return (
      <PatientSection
         title={'Aliments'}
         body={'Recherchez, consultez et ajoutez de nouveaux aliments au système'}
         withRight
         withAddBtn
         withFilter
         withSearch
         ...
         <View style={style.container}>
            {searchIsActive && (
               <View style={style.searchInputContainer}>
                  <SearchInput value={searchValue} setValue={setSearchValue} placeholder={'Recherchez des aliments'} />
               </View>
            )}
            {filterIsActive && (
            ...
            <FlatList
               ...
               renderItem={({ item, index }) => <FoodItem name={item.name} dbName={item.dbName} data={item.data} id={item.id} />}
