...
const SearchInput = (props: Props) => {
   const { onBlur = () => {}, onFocus = () => {}, isFocus = false, disableClearIcon = true, h, w, r, bw, st } = props;
   ...
   return (
      <View style={style.search({ h, w, r, bw, st })}>
         ...
         {disableClearIcon && (
            <Pressable style={style.iconContainer} onPress={() => props.onClear()}>
               <MaterialIcons name={'clear'} size={15} color={colors.gray} />
            </Pressable>
         )}
      </View>
   );
