...
const DateInput = (props: Props) => {
   ...
   const { label = 'Date', isRequire = false, onChange = () => {}, placeholder = 'YYYY-MM-DD', value = '' } = props;
   ...
   return (
      <View style={style.selectionInputContainer}>
         <TextInput
            ...
            rightIcon={(color, size) => <Ionicons name={displayPopup ? 'chevron-up' : 'chevron-down'} color={colors.black200} />}
            st={{
               paddingHorizontal: 0,
            }}
