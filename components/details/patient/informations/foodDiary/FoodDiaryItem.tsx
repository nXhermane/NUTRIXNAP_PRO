...
const FoodDiaryItem = ({ data, onPress ,onDelete}: Props) => {
    ...
    const [containerLayoutHeight, setContainerLayoutHeight] =
        useState<string>("65%");
                        ...
                        >
                            <View style={style.diaryHeader}>
                                <View style={style.mealsType}>
                                    <Text style={style.mealsTypeText}>
                                        {data?.mealsType}
                                    </Text>
                                </View>
                            ...
                            >
                                <React.Fragment>
                                    {data?.meals && (
                                        <Text style={style.mealsDetailText}>
                                            {data.meals}
                                        </Text>
                                    )}
                                </React.Fragment>
                                <React.Fragment>
                                    {data?.observations && (
                                        <Text style={style.observationsText}>
                                            {data.observations}
                                        </Text>
                                    )}
                                </React.Fragment>
