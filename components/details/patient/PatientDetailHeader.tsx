...
const PatientDetailHeader = ({
    ...
    const headerContainerStyle = useAnimatedStyle(() => ({
        backgroundColor: interpolateColor(
            scrollY.value,
            [0, 200],
            [colors.bg.primary + "10", colors.bg.secondary]
        ),
        ...
        <Animated.View style={[style.headerContainer, headerContainerStyle]}>
            <View style={style.headerTop}>
                ...
                <View style={style.headerTopCenter}>
                    <Text style={style.headerTopTitle}>
                        Profil du{" "}
                        <Text style={style.headerTopTitleHight}>Patient</Text>
                    </Text>
                </View>
            ...
            <Animated.View style={[style.headerBody, headerBodyStyle]}>
                ...
                <View style={style.headerBodyTextContainer}>
                    <Text style={style.headerBodyPatientName}>
                        {patient.name}
                    </Text>
                    <Text style={style.headerBodyPatientOccupancy}>
                        {patient.occupancy}
                    </Text>
                </View>
            </Animated.View>
            <View style={style.headerBottom}>
                ...
                <Animated.View
                    style={[style.bar, barWidthStyle, { width: size.s100 * 2 }]}
                >
